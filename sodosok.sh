...
cd /usr/bin
wget -O add-ss "http://file.panel-vpn.biz/script/ss/add-ss.sh"
wget -O del-ss "http://file.panel-vpn.biz/script/ss/del-ss.sh"
wget -O cek-ss "http://file.panel-vpn.biz/script/ss/cek-ss.sh"
wget -O renew-ss "http://file.panel-vpn.biz/script/ss/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
