...
#download
wget -O /usr/local/bin/PDirect.py http://file.panel-vpn.biz/script/install/PDirect.py
...
wget -O /usr/local/bin/ovpn.py http://file.panel-vpn.biz/script/install/ovpn.py
