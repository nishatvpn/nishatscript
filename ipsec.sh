...
wget -O /usr/bin/add-l2tp http://file.panel-vpn.biz/script/ipsec/add-l2tp.sh && chmod +x /usr/bin/add-l2tp
wget -O /usr/bin/del-l2tp http://file.panel-vpn.biz/script/ipsec/del-l2tp.sh && chmod +x /usr/bin/del-l2tp
wget -O /usr/bin/add-pptp http://file.panel-vpn.biz/script/ipsec/add-pptp.sh && chmod +x /usr/bin/add-pptp
wget -O /usr/bin/del-pptp http://file.panel-vpn.biz/script/ipsec/del-pptp.sh && chmod +x /usr/bin/del-pptp
wget -O /usr/bin/renew-pptp http://file.panel-vpn.biz/script/ipsec/renew-pptp.sh && chmod +x /usr/bin/renew-pptp
wget -O /usr/bin/renew-l2tp http://file.panel-vpn.biz/script/ipsec/renew-l2tp.sh && chmod +x /usr/bin/renew-l2tp
wget -O /usr/bin/cek-pptp http://file.panel-vpn.biz/script/ipsec/cek-pptp.sh && chmod +x /usr/bin/cek-pptp
