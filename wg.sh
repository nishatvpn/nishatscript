...
echo -e "${Info} Wireguard VPS AutoScript by whytzy96"
...
# Tambahan
cd /usr/bin
wget -O add-wg "http://file.panel-vpn.biz/script/wireguard/add-wg.sh"
wget -O del-wg "http://file.panel-vpn.biz/script/wireguard/del-wg.sh"
wget -O cek-wg "http://file.panel-vpn.biz/script/wireguard/cek-wg.sh"
wget -O renew-wg "http://file.panel-vpn.biz/script/wireguard/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
