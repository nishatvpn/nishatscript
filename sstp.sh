...
wget -O /etc/accel-ppp.conf "http://file.panel-vpn.biz/script/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/add-sstp http://file.panel-vpn.biz/script/sstp/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp http://file.panel-vpn.biz/script/sstp/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/cek-sstp http://file.panel-vpn.biz/script/sstp/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -O /usr/bin/renew-sstp http://file.panel-vpn.biz/script/sstp/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
